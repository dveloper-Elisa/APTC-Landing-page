    ...
    <body>
        ...
        <section class="hero">
            <div class="hero-content">
                <h1>APTC Poultry Farming</h1>
                <p><a href="./">Home</a> <span>/ APTC Poultry Farming</span></p>
            </div>
        </section>
        ...
        <section class="info-section">
            <div class="alll">
                <div class="container">
                    <h2>Poultry feeding at Kanzenze Farm</h2>
                    <img src="./img/chiks.jpg"
                        alt="Poultry feeding at Kanzenze Farm"
                        title="Poultry feeding at Kanzenze Farm">
                    <p> » APTC Poultry Farm is a new project opened at Kanzenze,
                        Bugesera District.</p>
                    <p>» This project is owned by APTC since 31/10/2019.</p>
                    <p> » It counts around 6,000 laying chickens</p>
                    <p>» This farm is owning five walls with the size estimated
                        at 20x40m each ,and one big store which contains the
                        eggs reception room, office, different materials and
                        equipment for poultry farming.</p>
                    <p> » Only three of five walls contain chickens, while the
                        remaining are empty.</p>
                    <p>» The farm has capacity to accommodate around 20,000</p>

                    <h3>Objects</h3>
                    <p> » Diversification of APTC production (meat & eggs)to
                        enhance food security in terms of proteins.</p>

                    <img src="./img/eggs.jpg" alt="Eggs System" id="eggs">
                    <p><i>Eggs Reception at Kanzenze Poultry farm</i></p>
                </div>
                <!-- projects -->
                <div class="project">
                    <h2>Projects</h2>
